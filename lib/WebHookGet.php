...
class webHookGet
{
    ...
    public $inline_query = false;
    public $callback_query_id = null;
    public $inline_query_id = null;
    ...
    public function __construct($telegram)
    {
		...
		{ 
            $this->inline_query = true;
            $this->inline_query_id = $result['inline_query']["id"];
            $this->text = $result['inline_query']["query"]; // Data instead of text in callback query
            $this->user_id = $result['inline_query']["from"]["id"];
            $this->first_name = isset( $result['inline_query']["from"]["first_name"] ) ? $result['inline_query']["message"]["from"]["first_name"] : null;
        }
